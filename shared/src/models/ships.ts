...
export interface Ship extends BuildableBase {
  type: 'ship';
  cost: Resources;
...
export const LargeCargoShip: Ship = {
...
export const SmallCargoShip: Ship = {
